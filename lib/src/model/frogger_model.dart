...
class LeapfroggerModel {
  ...
  factory LeapfroggerModel.fromRawJson(String str) =>
      LeapfroggerModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory LeapfroggerModel.fromJson(Map<String, dynamic> json) =>
      LeapfroggerModel(
